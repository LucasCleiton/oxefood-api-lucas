...
public class CategoriaProdutoController {
    ...
    /*
     * @PostMapping
     * public ResponseEntity<CategoriaProduto> save(@RequestBody
     * CategoriaProdutoRequest request) {
     * CategoriaProduto categoriaProduto =
     * categoriaProdutoService.save(request.build());
     * return new ResponseEntity<CategoriaProduto>(categoriaProduto,
     * HttpStatus.CREATED);
     * 
     * }
     */
    /*
     * /// ver melhor essa parte do codigo
     * 
     * @PostMapping("path")
     * public ResponseEntity<CategoriaProduto> save(@RequestBody @Valid
     * CategoriaProdutoRequest request) {
     * CategoriaProduto categoriaProdutoNovo = request.build();
     * CategoriaProduto categoriaProduto =
